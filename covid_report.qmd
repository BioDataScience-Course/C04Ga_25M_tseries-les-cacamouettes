...
```
A première vue, on observe une tendance à la diminution jusqu'au mois de septembre, suivie d'une augmentation.
Pour vérifier ces observations et éliminer le bruit, nous réalisons une décomposition de la série avec un filtrage par les valeurs propres, ainsi qu'un graphe d'autocorrélation.
```{r tsd_2021}
