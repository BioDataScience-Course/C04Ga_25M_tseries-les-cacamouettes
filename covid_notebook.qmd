...
```
La p-value étant inférieure au seuil \alpha de 5% pour la composante filtrée,nous rejetons H0. Il y a donc une tendance générale à l'augmentation est donc significative contrairement à ce que laissait croire le graphique de l'autocorrélation.
...
```
La tendance générale est en effet décroissante avec une valeur \rho négative et significative car la p-value est inférieure au seuil \alpha de 5%.
