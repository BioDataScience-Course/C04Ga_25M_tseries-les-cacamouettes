...
Décomposons la série. L'amplitude des cycles semblant varier avec la tendance, nous utilisons un modèle multiplicatif.
```{r}
...
Décomposons la série pour en savoir plus.
