...
covidw_ts21 <- window(covid$workplaces, start = 322, end = 686) 
covidw_ts21 <-ts(covidw_ts21, start = c(2021, 1), end = c(2021, 366), frequency = 366)
class(covidw_ts21)
...
```
Le périodogramme lissé détecte la présence de cycles significatifs à ~ 60 et 110 jours, soit bimestriel et quadrimestriel.
