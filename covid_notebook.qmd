...
covidw <- covid
covidw20 <- subset (covidw, format(date, "%Y") == "2020")
# Calcul des jours de la semaine
covidw20$weekdays <- weekdays(as.POSIXct(covidw20$date))
# Les données du week-end sont remplacées par des valeurs manquantes
covidw20[covidw20$weekdays %in% c("Saturday","Sunday"), "shop_leisure", "grocery_pharma", "parks", "stations", "workplaces", "residential"] <- NA
```
