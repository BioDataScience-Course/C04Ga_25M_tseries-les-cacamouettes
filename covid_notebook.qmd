...
```{r test_significativite_travail_2020}
...
```{r decomposition_2020_fevrier_juin}
...
```{r test_significativite_travail_2020_fevrier_juin}
...
```{r decomposition_2020_juin_decembre}
...
```{r test_significativite_travail_2020_juin_decembre}
...
```{r analyse_residus_2020_juin-decembre}
...
```{r testsignificativite_travail_2021}
...
```{r decomposition_2021_janvier_juin}
...
```{r test_significativite_travail_2021_janvier_juin}
...
```{r decomposition_2021_juin_decembre}
...
```{r test_significativite_travail_2021_juin_decembre}
