...
La composante filtered qui représente la série d'origine sans les cycles, semble présenter une tendance générale. De plus, les résidus semblent présenter des cycles. Nous convertissons notre objet en mts pour ensuite regarder l'autocorrélation de la composante filtrée :
...
La série présente une tendance générale qui semble croissante lorsque l'on observe la composante filtrée. Quant au graphique de l'autocorrélation il ne présente une autocorrélation à court terme ce qui suggèrerait qu'il n'y a pas de tendance générale mais peut-être une tendance locale. Concernant les résidus, la série semble présenter des cycles.
...
Les résidus ne présentent pas de cycle étant donné l'absence de pics. ####Année 2021
...
Si nous nous intéressons à l'année entière, tant 2020 que 2021, les deux séries présentent une tendance générale à l'augmentation et une absence de cycle. Concernant les périodes de début d'année, commençant mi-février pour 2020 et en janvier pour 2021 et se terminant fin juin : il n'y a pas de tendance générale significative ni de cycle que ce soit pour 2020 ou 2021. Concernant la période entre fin juin et décembre. En 2020, il y a une tendance générale croissante alors qu'en 2021, il y a une tendance générale décroissante.
...
Au niveau de la série filtrée, on observe une tendance générale positive. Dans les résidus, aucun cycle est aperçu.
