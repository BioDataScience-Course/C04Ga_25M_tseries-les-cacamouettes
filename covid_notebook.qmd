...
plot (weekshop_2020, 
  xlab = "Déplacements", 
  ylab = "Temps [mois]", 
  main = "Série avec uniquement les données pour les semaines")
```
...
plot (weekendshop_2020, 
  xlab = "Déplacements", 
  ylab = "Temps [mois]", 
  main = "Série avec uniquement les données pour les weekends")
```
...
plot (shop_sl, stat = "mean", leg = TRUE, xlab = "Déplacements", 
  ylab = "Temps [mois]", 
  main = "Statistiques glissante sur la série d'origine" )
