...
La série ne semble pas présenter de grosses chutes liées aux déplacements vers les lieux de travail si ce n'est quelques chutes aigues et brèves à certains moments de l'année.

```{r acf_travail_2021 }
acf(covidwork_2021, main = "Graphique d'autocorrélation 2021")
```

Ce graphique d'autocorrélation ne semble pas non plus avoir de cycles. De plus, uniquement les deuxième et troisième barres sont significatives ce qui pourrait se traduire par un effet miroir à court terme. Nous décomposons la série afin de l'analyser plus en détail :
